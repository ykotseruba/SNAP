...
class COCO:
    def __init__(self, annotation_file=None, verbose=False):
        ...
        if annotation_file is not None:
            self.log('loading annotations into memory...')
            tic = time.time()
            ...
            assert isinstance(
                ...
                dict), 'annotation file format {} not supported'.format(
                    type(dataset))
            self.log('Done (t={:0.2f}s)'.format(time.time() - tic))
    ...
    def loadRes(self, resFile):
        ...
        self.log('Loading and preparing results...')
        tic = time.time()
    ...
    def download(self, tarDir=None, imgIds=[]):
        ...
        for i, img in enumerate(imgs):
            ...
            self.log('downloaded {}/{} images (t={:0.1f}s)'.format(
                i, N,
                time.time() - tic))
    ...
    def loadNumpyAnnotations(self, data):
        ...
        """
        self.log('Converting ndarray to lists...')
